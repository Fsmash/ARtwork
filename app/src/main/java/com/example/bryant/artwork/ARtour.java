...
/**
 * Created by bryant on 11/19/16.
 */

public class ARtour extends AppCompatActivity {

    // String for wikitude trial.
    ...
    protected void onPostCreate(final Bundle savedInstanceState) {
        ...
        if (this.architectView != null) {
            ...
            try {
                this.architectView.load("ARtourWorld/index.html");
    ...
    private void permissionCheck() {
        // Taken from "https://developer.android.com/training/permissions/requesting.html#perm-request"
                ...
                builder.setMessage("Camera needs to be enabled for AR experience.").setTitle("App Unable to Start")
                        .setPositiveButton(R.string.AlertDialog_OK, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ActivityCompat.requestPermissions(ARtour.this,
